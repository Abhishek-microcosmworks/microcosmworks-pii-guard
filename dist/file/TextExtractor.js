...
const WRITABLE_FORMATS = new Set([
...
export function isWritableFormat(format) {
...
async function extractFromBuffer(buf, format, encoding) {
...
async function extractPdf(buf) {
    ...
    try {
        ...
        throw new Error('pdf-parse is required for PDF extraction. Install it:\n  npm install pdf-parse');
    }
...
async function extractDocx(buf) {
    ...
    try {
        ...
        throw new Error('mammoth is required for DOCX extraction. Install it:\n  npm install mammoth');
    }
